...
console.log('Start->');
console.log("-------------------------");
//大原则:普通函数需要别人告诉他this,也就是谁调用,this就指向谁; 箭头函数只认出生地，如何调用都不改变this指向
...
//part2
{
    ...
    // class classPerson { //由上面的写法改写而来,也是块级作用域
    //     constructor(){
    //         this.name = 'Ming_3';
    //     }
    //     climbing = function() {
    //         console.log(this);
    //     }  // 如果是写成climbing(){}, 就打印不出来
    //     swimming = () => {
    //         console.log(this);
    //     } //等同于上面的写法,this用法也相同
    // }
    ...
    // const func2_1 = ming_2.climbing; //将class内部的function,传到class外界
    // const func2_2 = ming_2.swimming;
    
    // const func3_1 = ming_3.climbing;
    // const func3_2 = ming_3.swimming;
    // func2_1(); //只是将函数的地址传出,传给func2_1,并在window下调用func2_1
    // func2_2();//将函数的地址传出,传给func2_1,但箭头函数的this在出生时就已确定,所以无论在哪里调用，this指向都不变
    // func3_1();
    // func3_2();
}
//part3
